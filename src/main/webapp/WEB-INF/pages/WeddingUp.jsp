<%-- 
    Document   : WeddingUp
    Created on : Apr 15, 2022, 1:29:57 AM
    Author     : billg
--%>
...
<div class="w3-content w3-padding w3-card" style="max-width:500px">
    <div class="w3-container w3-padding-32">
        <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16"
            style="color: DeepSkyBlue;">Update Party</h3>
            <hr>
        <form method="post" action="" modelAttribute="wedding" enctype="multipart/form-data">
            <p>
                <label hidden="true">wedding id</label>

                <input hidden="true" class="w3-input w3-border fixedinput" type="text" id="" name="idWedding" value="${wedding.idWedding}" >
            </p>
            <p>
                <label>wedding name</label>
                <input class="w3-input w3-border fixedinput" type="text" id="" name="name" value="${wedding.name}">
            </p>
            <p>
                <label>wedding Price</label>
                <input class="w3-input w3-border fixedinput" type="text" id="" name="price" value="${wedding.price}">
            </p>
            <p>
                <label>wedding detail</label>
                <input class="w3-input w3-border fixedinput" type="text" id="" name="detail" value="${wedding.detail}">
            </p>
            <p>
                <label>wedding duration</label>
                <input class="w3-input w3-border fixedinput" type="text" id="" name="duration" value="${wedding.duration}">
            </p>
            <p>
