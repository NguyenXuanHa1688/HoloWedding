<%-- 
    Document   : errorPage
    Created on : Apr 15, 2022, 3:39:40 PM
    Author     : billg
--%>
...
<div class="error">
  ...
  <div class="error__subtitle">${errMes}</div>
  <div class="error__description">It looks like one of the  developers fell asleep</div>
  <button class="error__button error__button--active" onclick="history.back()">GO BACK</button>
</div>
